...
import { IoCar, IoHeadset, IoShieldHalf, IoCard } from "react-icons/io5";
...
export const serviceData = [
  {
    icon: React.createElement(IoCar),
    title: "Free Shipping",
    subtitle: "Lorem ipsum dolor sit amet.",
    bg: "#fdefe6",
  },
  {
    icon: React.createElement(IoCard),
    title: "Safe Payment",
    subtitle: "Lorem ipsum dolor sit amet.",
    bg: "#ceebe9",
  },
  {
    icon: React.createElement(IoShieldHalf),
    title: "Secure Payment",
    subtitle: "Lorem ipsum dolor sit amet.",
    bg: "#e2f2b2",
  },
  {
    icon: React.createElement(IoHeadset),
